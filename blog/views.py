...
class PostDetailView(View):
    def get(self, request, slug, *args, **kwargs):
        ...
        return render(request, 'blog/post.html', context={
            'post': post, 'common_tags': common_tags, 'last_posts': last_posts, 'comment_form': comment_form})
    ...
    def post(self, request, slug, *args, **kwargs):
        ...
        return render(request, 'blog/post.html', context={'comment_form': comment_form})
...
class SearchResultsView(View):
    def get(self, request, *args, **kwargs):
        ...
        page_number = request.GET.get('page')
        page_obj = paginator.get_page(page_number)
        return render(request, 'blog/search.html', context={'title': 'Поиск', 'results': page_obj, 'count': paginator.count})
...
class TagView(View):
    def get(self, request, slug, *args, **kwargs):
        ...
        common_tags = Post.tag.most_common()
        return render(request, 'blog/tag.html', context={'title': f'#ТЕГ {tag}', 'posts': posts, 'common_tags': common_tags})
